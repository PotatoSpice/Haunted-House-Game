...
import collections.tree.adt.HeapADT;
...
public class LinkedHeap<T> extends LinkedBinaryTree<T> implements HeapADT<T> {
    ...
    public void addElement(T obj) {
        ...
        if (root == null) root = node;
            ...
            if (next_parent.left == null) next_parent.left = node;
            else next_parent.right = node;
    ...
    private HeapNode<T> getNextParentAdd() {
        ...
        if (result != root) if (result.parent.right == null) result = result.parent;
        else {
            result = (HeapNode<T>) result.parent.right;
            while (result.left != null) result = (HeapNode<T>) result.left;
        }
        else while (result.left != null) result = (HeapNode<T>) result.left;
        return result;
    }
